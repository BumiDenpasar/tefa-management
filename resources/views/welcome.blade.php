...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
      ...
      .slider-container {
          ...
          .slide {
              flex: 0 0 400px; /* Set a wider width for the slide */
              margin-right: 20px; /* Space between slides */
              background-color: white; /* Background color */
              border-radius: 8px; /* Rounded corners */
              box-shadow: 0 4px 8px rgba(0,0,0,0.1); /* Add shadow for depth */
              height: 400px; /* Set a fixed height for a rectangular shape */
          ...
          @keyframes scroll {
              ...
              100% { transform: translateX(-50%); } /* Scroll to half to allow looping */
          }
          ...
          @keyframes upDown {
            ...
            /* Adjust -10px for height movement */
          }
    ...
    <body class="scroll-smooth leading-normal w-screen overflow-x-hidden tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
          ...
          <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
              <ul class="list-reset lg:flex justify-end flex-1 items-center text-white-scroll">
                <li class="mr-3">
                  <a class="inline-block py-2 px-4 text-black text-white-scroll font-bold no-underline" href="#contact">Contact Us</a>
                </li>
                <li class="mr-3">
                  <a class="inline-block text-white-scroll text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#about">About Us</a>
                </li>
                <li class="mr-3">
                  <a class="inline-block text-white-scroll text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#information">Information</a>
                </li>
              </ul>
              <a
                href="/tefa"
        ...
        <div class="pt-24">
          <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex space-x-4">
              <a href="/tefa/login"
                class="mx-auto lg:mx-0 bg-purple-900 text-white hover:bg-white hover:text-purple-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition-all hover:scale-105 duration-300 ease-in-out">
                Login
            </a>
              <a id="registerAction" href="/tefa/register"
                class="mx-auto lg:mx-0 hover:bg-purple-900 hover:text-white bg-white text-purple-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition-all hover:scale-105 duration-300 ease-in-out">
                Register
          </a>
            </div>
          </div>
          <div class="w-full md:w-3/5 py-6 text-center flex justify-end" data-aos="fade-up"
          data-aos-easing="linear"
          data-aos-duration="1500">
            <img class="w-full md:w-4/5 z-0 animate-upDown" src="/images/hero.png" alt="Hero Image" />
          </div>
        </div>
        <div class="relative mt-36 hero_area">
        ...
        <section class="bg-white border-b py-8"></section>
        <div class="container max-w-5xl mx-auto m-8" id="about">
          ...
          <div class="flex flex-wrap" data-aos="zoom-in-right">
            <div class="w-5/6 sm:w-1/2 p-6">
              <h3 class="text-3xl text-purple-900 font-bold leading-none mb-3">
                Monitoring TeFa
              </h3>
              <p class="text-white mb-8">
                TeFa SMKN 4 Kota Bogor menghadirkan sistem informasi mengenai TeFa yang didampingi oleh industri, mencakup
                berbagai aspek seperti hasil riset, produk, omzet, dan lain-lain. Sistem ini memberikan informasi tentang TeFa
                mana yang telah mencapai kelayakan bisnis untuk masyarakat, serta menawarkan dukungan dalam hal permodalan,
                pemasaran, dan perluasan pasar melalui relasi industri.
                <br />
                <br />
              </p>
            </div>
            ...
            data-aos-duration="500">
              <svg class="w-full sm:h-64 mx-auto animate-upDown" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                <title>Wolrd</title>
                ...
                <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#a743dd" />
                <path transform="translate(-11.5 -150.75)"
                  d="M1017,282.42V294H183V282.42A20.42,20.42,0,0,1,203.42,262H996.58A20.42,20.42,0,0,1,1017,282.42Z"
                  fill="#3f3d56" />
                <circle cx="193" cy="127.75" r="6" fill="#a743dd" />
                <circle cx="208" cy="127.75" r="6" fill="#a743dd" />
                <circle cx="223" cy="127.75" r="6" fill="#a743dd" />
                <path transform="translate(-11.5 -150.75)"
                ...
                <path transform="translate(-11.5 -150.75)"
                  ...
                  fill="#3f3d56" />
                <rect x="604" y="260.14" width="347" height="11" rx="1.24" fill="#a743dd" opacity=".3" />
                <rect x="604" y="392.07" width="347" height="11" rx="1.24" fill="#a743dd" opacity=".3" />
                <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#a743dd" />
                <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#a743dd" />
                <path transform="translate(-11.5 -150.75)"
          ...
          <div class="flex flex-wrap flex-col-reverse sm:flex-row" data-aos="zoom-in-left">
            <div class="w-full sm:w-1/2 p-6 mt-6">
              <svg class="w-5/6 sm:h-64 mx-auto transform transition hover:scale-110 duration-300 ease-in-out" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                <title>connected to us</title>
                ...
                <path transform="translate(-11.697 -13.011)"
                  ...
                  fill="none" opacity=".8" stroke="#a743dd" stroke-miterlimit="10" stroke-width="2" />
                <path transform="translate(-11.697 -13.011)"
                  ...
                  fill="none" opacity=".8" stroke="#a743dd" stroke-miterlimit="10" stroke-width="2" />
                <circle cx="214.07" cy="310.65" r="11.968" fill="#a743dd" />
                <circle cx="322.2" cy="566.52" r="11.968" fill="#a743dd" />
                <circle cx="780.7" cy="309" r="11.968" fill="#a743dd" />
                <circle cx="991.17" cy="607.78" r="11.968" fill="#a743dd" />
                <circle cx="600.35" cy="480.68" r="11.968" fill="#a743dd" />
              </svg>
            </div>
            <div class="w-full sm:w-1/2 p-6 mt-6">
              <div class="align-middle">
                ...
                <p class="text-white mb-8">
                  Program ini bertujuan untuk mempermudah masyarakat dan pelaku industri dalam mengakses informasi yang
                  relevan, sehingga dapat mendorong pengembangan dan keberlanjutan bisnis di lingkungan sekolah dan
                  masyarakat.
                  Dengan adanya sistem informasi ini, SMKN 4 Kota Bogor berharap dapat berkontribusi secara signifikan dalam
                  menciptakan lapangan kerja dan meningkatkan daya saing lulusan dalam dunia kerja.
                  <br />
                  <br />
                </p>
              </div>
        ...
        <section class="bg-white border-b py-8" id="information">
          <div class="container mx-auto flex flex-wrap pt-4 pb-12"data-aos="zoom-in-up">
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-purple-900">
              Informasi TeFa SMKN 4 Kota Bogor
            </h1>
            <div class="w-full mb-4">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                  ...
                  <p class="text-gray-800 text-base px-6 mb-5">
                    Temukan hasil riset yang telah dilakukan oleh TeFa bersama industri, mencakup inovasi produk dan teknologi
                    terbaru.
                  </p>
                </a>
              </div>
              <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div class="flex items-center justify-start">
                  <button
                    class="mx-auto lg:mx-0 hover:underline bg-purple-900 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Lihat Riset
                  </button>
                </div>
              </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                  ...
                  <p class="text-gray-800 text-base px-6 mb-5">
                    Jelajahi berbagai produk unggulan yang dihasilkan oleh TeFa SMKN 4 Kota Bogor, dari prototipe hingga
                    produk siap pasar.
                  </p>
                </a>
              </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                  ...
                  <p class="text-gray-800 text-base px-6 mb-5">
                    Pelajari tentang dukungan permodalan, kemitraan dengan industri, dan strategi pemasaran untuk memperluas
                    pasar TeFa.
                  </p>
                </a>
              </div>
        ...
        <section class="container mx-auto py-6 mb-12 flex flex-wrap" id="contact">
          <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
            Contact Us
          </h1>
          <div class="w-full mb-4">
          ...
          data-aos-offset="300"
          data-aos-easing="ease-in-sine" class="w-full md:w-1/2 p-6">
            <h1 class="text-4xl font-bold leading-tight text-purple-900 mb-4 text-center">
              Form Pengaduan
            </h1>
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              <!-- Input Nama dan Email Berdampingan -->
              ...
              <!-- Input Telp dan Subject Berdampingan -->
              <div class="flex flex-wrap mb-4">
                <div class="w-full md:w-1/2 px-2">
                  ...
                  <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="telp" type="text" placeholder="Masukkan Nomor Telepon">
                </div>
                <div class="w-full md:w-1/2 px-2">
                  ...
                  <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="subject" type="text" placeholder="Masukkan Subject">
                </div>
              </div>
              ...
              <div class="mb-4">
                ...
                <textarea
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="pesan" rows="4" placeholder="Tulis pesan Anda"></textarea>
              </div>
              <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="captcha" type="text" placeholder="Masukkan Captcha">
              </div>
              <div class="mb-6">
                <p class="text-xs text-gray-600">
                  Dengan ini saya menyatakan bahwa data yang saya kirim adalah benar dan valid. Saya bersedia menerima sanksi
                  sesuai dengan ketentuan peraturan perundang-undang yang berlaku jika data yang saya kirim tidak benar dan
                  tidak valid.
                </p>
              </div>
              <div class="flex items-center justify-between">
                <button
                  class="w-full lg:mx-0 hover:underline bg-purple-900 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                  type="submit">
                  Submit
                </button>
              </div>
          ...
          <!-- Lokasi Google Maps -->
          <div data-aos="fade-left" class="w-full md:w-1/2 p-6">
            <h1 class="text-4xl font-bold leading-tight text-white mb-4 text-center">
              Lokasi Kami
            </h1>
            <div class="shadow-lg rounded overflow-hidden mb-6">
              <iframe class="w-full h-96"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.0498397504402!2d106.81982298162181!3d-6.64073337621703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c8b16ee07ef5:0x14ab253dd267de49!2sSMK%20Negeri%204%20Bogor%20(Nebrazka)!5e0!3m2!1sid!2sid!4v1727346451996!5m2!1sid!2sid"
                frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
      
            <section class="container mx-auto" data-aos="fade-up">
              <h1 class="text-4xl font-bold leading-tight text-center text-white mb-8">
                Contact Information
              </h1>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-aos="fade-up">
                ...
                <div class="flex items-center bg-white rounded-lg shadow-md p-4">
                  <div class="flex-shrink-0 bg-blue-100 p-3 rounded">
                    <img
                      src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Instagram_logo_2022.svg/600px-Instagram_logo_2022.svg.png"
                      alt="Technical Support Icon" class="h-8 w-8" />
                  </div>
                  <div class="ml-4">
                    <h2 class="text-lg font-semibold text-purple-900">Instagram Account</h2>
                    <a href="https://www.instagram.com/smkn4kotabogor"
                      class="text-gray-600 hover:underline hover:text-black">@smkn4kotabogor</a>
                    <br />
                    <a href="https://www.instagram.com/chlorineofficial"
                      class="text-gray-600 hover:underline hover:text-black">@chlorineofficial</a>
                  </div>
                </div>
                ...
                <div class="flex items-center bg-white rounded-lg shadow-md p-4">
                  <div class="flex-shrink-0 bg-blue-100 p-3 rounded">
                    <img src="https://ssl.gstatic.com/images/branding/product/2x/hh_gmail_96dp.png" alt="Sales Questions Icon"
                      class="h-8 w-8" />
                  </div>
                  <div class="ml-4">
                    <h2 class="text-lg font-semibold text-purple-900">Email</h2>
                    <a href="mailto:smkn4@smkn4bogor.sch.id"
                      class="text-gray-600 hover:underline hover:text-black">smkn4@smkn4bogor.sch.id</a>
                    <br />
                    <a href="mailto:info@chlorinedigitalmedia.com"
                      class="text-gray-600 hover:underline hover:text-black">info@chlorinedigitalmedia.com</a>
                  </div>
                </div>
                ...
                <div class="flex items-center bg-white rounded-lg shadow-md p-4">
                  <div class="flex-shrink-0 bg-blue-100 p-3 rounded">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg"
                      alt="Press Icon" class="h-8 w-8" />
                  </div>
                  <div class="ml-4">
                    <h2 class="text-lg font-semibold text-purple-900">Facebook</h2>
                    <a href="https://www.facebook.com/smknegeri4bogor"
                      class="text-gray-600 hover:underline hover:text-black">smknegeri4bogor</a>
                    <br />
                    <a href="https://www.facebook.com/chlorine.digitalmedia"
                      class="text-gray-600 hover:underline hover:text-black">chlorine.digitalmedia</a>
                  </div>
                </div>
                ...
                <div class="flex items-center bg-white rounded-lg shadow-md p-4">
                  <div class="flex-shrink-0 bg-blue-100 p-3 rounded">
                    <img src="https://smkn4bogor.sch.id/assets/images/logo/pplg.png" alt="Bug Report Icon" class="h-8 w-8" />
                  </div>
                  <div class="ml-4">
                    <h2 class="text-lg font-semibold text-purple-900">Kr4bat PPLG</h2>
                    <a href="https://www.instagram.com/kr4bat_pplg/"
                      class="text-gray-600 hover:underline hover:text-black">@kr4bat_pplg</a>
                  </div>
                </div>
              </div>
            </section>
        ...
        <footer class="bg-gray-50">
          <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center sm:justify-between">
              <div class="flex items-center justify-between">
                <img src="/images/chlorine.png" class="h-10">
              </div>
            </div>
      ...
      <script>
        ...
        var navaction = document.getElementById("getStarted");
      ...
      mainContent.innerHTML = `
        <div class="container mx-auto py-8">
          <button class="flex items-center text-2xl font-semibold mb-4 text-purple-900" onclick="location.reload()">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8" data-aos="zoom-in">
            <!-- Akun Perorangan -->
            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col h-full">
              <div class="flex justify-center mb-4">
                <div class="bg-blue-100 p-4 rounded-full">
                  <img src="https://img.icons8.com/fluency/48/000000/document.png" alt="icon" class="w-12 h-12">
                </div>
              </div>
              <h2 class="text-xl font-semibold text-center mb-2 text-purple-900">Akun Perorangan</h2>
              <p class="text-center text-gray-600 font-medium mb-4">
                Jenis layanan yang dapat diakses adalah sebagai berikut:
              </p>
              <ul class="text-center text-gray-600 space-y-1 mb-6">
                <li>Pembuatan AK-1 (Kartu Pencari Kerja / Kartu Kuning)</li>
                <li>Pendaftaran Uji Kompetensi</li>
                <li>Pemagangan Kerja</li>
                <li>Pelatihan Kerja</li>
                <li>Pengaduan</li>
                <li>Informasi Lowongan Kerja</li>
              </ul>
              <div class="mt-auto flex justify-center">
                <button class="mx-auto lg:mx-0 hover:bg-purple-900 hover:text-white bg-white text-purple-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition-all hover:scale-105 duration-300 ease-in-out">
                  Register
                </button>
              </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col h-full">
              ...
              <h2 class="text-xl font-semibold text-center mb-2 text-purple-900">Akun Badan Usaha</h2>
              <p class="text-center text-gray-600 font-medium mb-4">
                Jenis layanan yang dapat diakses adalah sebagai berikut:
              </p>
              <ul class="text-center text-gray-600 space-y-1 mb-6">
                <li>Perizinan Lembaga Pelatihan Kerja</li>
                <li>Pendaftaran Perjanjian Kerja Waktu Tertentu</li>
                <li>Pencatatan Perselisihan dan Mediasi</li>
                <li>Pengesahan Peraturan Perusahaan (PP)</li>
                <li>Pendaftaran Perjanjian Kerja Bersama</li>
                <li>Pengiklanan Lowongan Kerja</li>
                <li>Perizinan Bursa Kerja Khusus</li>
                <li>Perizinan Pemagangan Mandiri</li>
              </ul>
              <div class="mt-auto flex justify-center">
                <button class="mx-auto lg:mx-0 bg-purple-900 text-white hover:bg-white hover:text-purple-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition-all hover:scale-105 duration-300 ease-in-out">
                  Register
                </button>
              </div>
            </div>
    ...
    // Add event listeners to both "Get Started" and "Register" buttons
    document.getElementById('getStarted').addEventListener('click', loadRegisterForm);
    document.getElementById('registerAction').addEventListener('click', loadRegisterForm);
    
    async function fetchNews() {
            const response = await fetch('https://api-berita-indonesia.vercel.app/antara/tekno/');
            ...
            // Duplicate the posts to create a seamless effect
            const allPosts = [...posts, ...posts]; // Duplicate posts
        ...
        <div class="p-4">
            <!-- Title text with purple-900 color -->
            <div class="font-bold text-lg mb-2 text-purple-900">${post.title}</div>
            <p class="text-gray-700 text-base">${post.description}</p>
            <!-- Full-width button with transition and hover effects -->
            <a href="${post.link}" target="_blank" class="w-full block bg-purple-900 text-white font-bold rounded-full py-4 px-8 mt-4 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out text-center">Read More</a>
        </div>
    </div>
    
                `;
                newsSlider.innerHTML += slide;
            });
        }
