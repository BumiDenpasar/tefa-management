...
<body class="bg-gray-100 p-8 text-sm">
    <div class="w-full flex items-center justify-between">
        ...
        <div>
            <a href="./school_report/weekly" class="no-print mt-6 bg-purple-500 text-white py-2 px-4 rounded-md hover:rounded-full hover:bg-blue-600">Weekly</a>
            <a href="./school_report/monthly" class="no-print mt-6 bg-purple-500 text-white py-2 px-4 rounded hover:bg-blue-600">Monthly</a>
            <a href="./school_report/yearly" class="no-print mt-6 bg-purple-500 text-white py-2 px-4 rounded hover:bg-blue-600">Yearly</a>
