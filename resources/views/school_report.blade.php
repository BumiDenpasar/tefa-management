...
<body class="bg-gray-50 p-6 md:p-8" style="-webkit-print-color-adjust: exact; 
">
    <!-- Navigation Bar -->
    <div class="max-w-7xl mx-auto mb-8 no-print">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="./school_report/weekly" class="no-print px-4 py-2 text-sm font-medium text-white bg-indigo-500 rounded-full hover:bg-indigo-600 transition-all shadow-sm hover:shadow">Weekly</a>
                <a href="./school_report/monthly" class="no-print px-4 py-2 text-sm font-medium text-white bg-indigo-500 rounded-full hover:bg-indigo-600 transition-all shadow-sm hover:shadow">Monthly</a>
                <a href="./school_report/yearly" class="no-print px-4 py-2 text-sm font-medium text-white bg-indigo-500 rounded-full hover:bg-indigo-600 transition-all shadow-sm hover:shadow">Yearly</a>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm p-6 mb-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Overall School Report</h1>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-indigo-500 to-blue-500 text-white rounded-lg">
