    ...
    <div class="max-w-7xl mx-auto mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="./monthly" class="no-print px-4 py-2 text-sm font-medium text-white bg-indigo-500 rounded-full hover:bg-indigo-600 transition-all shadow-sm hover:shadow">Monthly</a>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{\Carbon\Carbon::parse($time)->format('Y')}} School Report</h1>
