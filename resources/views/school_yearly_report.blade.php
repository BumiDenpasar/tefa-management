...
<body class="bg-gray-100 p-8 text-sm">
    <div class="w-full flex items-center justify-between">
        ...
        <div>
            ...
            <a href="./monthly" class="no-print mt-6 bg-purple-500 text-white py-2 px-4 rounded hover:bg-blue-600">Monthly</a>
            <a href="../school_report" class="no-print mt-6 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Overall</a>
